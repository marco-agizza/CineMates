...
final class ResponseHandler {
    ...
    /// - Throws: `ErrorManager`.
    func mapResponse(_ sessionResponse: (data: Data, response: URLResponse)) throws -> Data {
        guard let httpResponse = sessionResponse.response as? HTTPURLResponse else {
        ...
        default:
            throw NetworkError.http(httpResponse: httpResponse, data: sessionResponse.data)
        }
    }
